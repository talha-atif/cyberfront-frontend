...
const NavLink = ({ children, href, isActive }) => (
  <a
    href={href}
    className={`px-2 py-2.5 text-sm font-medium leading-5 whitespace-nowrap hover:bg-sky-950 hover:text-white focus:outline-none focus:underline focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-white rounded-md ${
...
const navLinks = [
  { label: "Home", href: "/blue-dashboard" },
